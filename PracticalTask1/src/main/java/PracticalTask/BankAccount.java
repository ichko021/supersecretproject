...
public class BankAccount {
    ...
    public static void top_up(double balance){
    ...
    public static void bankOperations(int method) throws IOException {
        ...
        for (Contact c : MyAccount.getContacts()) {
            double get_user_balance = Actions.usrMyAcc.getBankAccount().getBalance();
                ...
                if (method == 1) {
                    try {
                        if(des_balance>get_user_balance){
                            ...
                            Actions.usrMyAcc.getBankAccount().setBalance(get_user_balance - des_balance);
                            c.getBankAccount().setBalance(get_contact_balance + des_balance);
                            System.out.println("The transaction was successful.");
                            String payment_statement = Actions.usrMyAcc.getFirstName() + " paid " + des_balance + " BGN to " + c.getPhone() + "\n";
                    ...
                    try {
                        if(des_balance>get_contact_balance){
                            ...
                            c.getBankAccount().setBalance(get_contact_balance - des_balance);
                            System.out.println("The transaction was successful.");
                            String refund_statement = Actions.usrMyAcc.getFirstName() + " refunded " + des_balance + " BGN from " + c.getPhone() + "\n";
